...
create_extensible_enum!(ActionType, (Internal, "Internal"));
...
create_extensible_enum!(AffinityStrength, (Must, "Must"), (Should, "Should"));
...
create_extensible_enum!(AzureHybridBenefitType, (None, "None"), (SqlHost, "SqlHost"));
...
create_extensible_enum!(DhcpTypeEnum, (RELAY, "RELAY"), (SERVER, "SERVER"));
...
create_extensible_enum!(DnsZoneType, (Private, "Private"), (Public, "Public"));
...
create_extensible_enum!(InternetEnum, (Disabled, "Disabled"), (Enabled, "Enabled"));
...
create_extensible_enum!(MountOptionEnum, (ATTACH, "ATTACH"), (MOUNT, "MOUNT"));
...
create_extensible_enum!(PlacementPolicyType, (VmHost, "VmHost"), (VmVm, "VmVm"));
...
create_extensible_enum!(QuotaEnabled, (Disabled, "Disabled"), (Enabled, "Enabled"));
...
create_extensible_enum!(SslEnum, (Disabled, "Disabled"), (Enabled, "Enabled"));
