...
use crate::models::{WorkloadNetworkVMGroup, WorkloadNetworkVMGroupsList};
use azure_core::{
...
impl AVSWorkloadNetworkVmGroupsClient {
    ...
    pub async fn create(
        ...
        options: Option<AVSWorkloadNetworkVmGroupsClientCreateOptions<'_>>,
    ...
    pub async fn delete(
        ...
        vm_group_id: String,
        private_cloud_name: String,
        options: Option<AVSWorkloadNetworkVmGroupsClientDeleteOptions<'_>>,
    ) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get(
        ...
        private_cloud_name: String,
        vm_group_id: String,
        options: Option<AVSWorkloadNetworkVmGroupsClientGetOptions<'_>>,
    ) -> Result<Response<WorkloadNetworkVMGroup>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub fn list(
        ...
        resource_group_name: String,
        private_cloud_name: String,
        options: Option<AVSWorkloadNetworkVmGroupsClientListOptions<'_>>,
        ...
        Ok(Pager::from_callback(move |next_link: Option<Url>| {
            ...
            async move {
                let rsp: Response<WorkloadNetworkVMGroupsList> =
    ...
    pub async fn update(
        ...
        vm_group_id: String,
        workload_network_vm_group: RequestContent<WorkloadNetworkVMGroup>,
        options: Option<AVSWorkloadNetworkVmGroupsClientUpdateOptions<'_>>,
    ) -> Result<Response<WorkloadNetworkVMGroup>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
