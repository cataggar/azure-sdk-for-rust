...
impl AVSWorkloadNetworkDnsServicesClient {
    ...
    pub async fn create(&self, resource_group_name: String, private_cloud_name: String, dns_service_id: String, workload_network_dns_service: RequestContent<WorkloadNetworkDnsService>, options: Option<AVSWorkloadNetworkDnsServicesClientCreateOptions<'_>>) -> Result<Response<WorkloadNetworkDnsService>> {
    ...
    pub async fn delete(&self, resource_group_name: String, dns_service_id: String, private_cloud_name: String, options: Option<AVSWorkloadNetworkDnsServicesClientDeleteOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}");
    ...
    pub async fn get(&self, resource_group_name: String, private_cloud_name: String, dns_service_id: String, options: Option<AVSWorkloadNetworkDnsServicesClientGetOptions<'_>>) -> Result<Response<WorkloadNetworkDnsService>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}");
    ...
    pub fn list(&self, resource_group_name: String, private_cloud_name: String, options: Option<AVSWorkloadNetworkDnsServicesClientListOptions<'_>>) -> Result<Pager<WorkloadNetworkDnsServicesList>> {
        ...
        Ok(Pager::from_callback(move |next_link: Option<Url>| {
            ...
            async move {
                let rsp: Response<WorkloadNetworkDnsServicesList> = pipeline.send(&ctx, &mut request).await?;
    ...
    pub async fn update(&self, resource_group_name: String, private_cloud_name: String, dns_service_id: String, workload_network_dns_service: RequestContent<WorkloadNetworkDnsService>, options: Option<AVSWorkloadNetworkDnsServicesClientUpdateOptions<'_>>) -> Result<Response<WorkloadNetworkDnsService>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/dnsServices/{dnsServiceId}");
