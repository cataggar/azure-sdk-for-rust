...
impl AVSClient {
    pub fn new(endpoint: &str, credential: Arc<dyn TokenCredential>, subscription_id: String, options: Option<AVSClientOptions>) -> Result<Self> {
    ...
    pub fn get_avs_workload_network_dhcp_configurations_client(&self) -> AVSWorkloadNetworkDhcpConfigurationsClient {
    ...
    pub fn get_avs_workload_network_dns_services_client(&self) -> AVSWorkloadNetworkDnsServicesClient {
    ...
    pub fn get_avs_workload_network_port_mirroring_profiles_client(&self) -> AVSWorkloadNetworkPortMirroringProfilesClient {
    ...
    pub fn get_avs_workload_network_virtual_machines_client(&self) -> AVSWorkloadNetworkVirtualMachinesClient {
