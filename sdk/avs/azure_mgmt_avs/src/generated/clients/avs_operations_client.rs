...
use azure_core::{
    ClientMethodOptions, Method, Pager, Pipeline, Request, Response, Result, Url,
};
...
impl AVSOperationsClient {
    ...
    pub fn list(&self, options: Option<AVSOperationsClientListOptions<'_>>) -> Result<Pager<OperationListResult>> {
