...
use crate::models::{WorkloadNetworkPortMirroring, WorkloadNetworkPortMirroringList};
use azure_core::{
...
impl AVSWorkloadNetworkPortMirroringProfilesClient {
    ...
    pub async fn create(
        ...
        options: Option<AVSWorkloadNetworkPortMirroringProfilesClientCreateOptions<'_>>,
    ...
    pub async fn delete(
        ...
        port_mirroring_id: String,
        private_cloud_name: String,
        options: Option<AVSWorkloadNetworkPortMirroringProfilesClientDeleteOptions<'_>>,
    ) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub async fn get(
        ...
        private_cloud_name: String,
        port_mirroring_id: String,
        options: Option<AVSWorkloadNetworkPortMirroringProfilesClientGetOptions<'_>>,
    ) -> Result<Response<WorkloadNetworkPortMirroring>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
    ...
    pub fn list(
        ...
        resource_group_name: String,
        private_cloud_name: String,
        options: Option<AVSWorkloadNetworkPortMirroringProfilesClientListOptions<'_>>,
        ...
        Ok(Pager::from_callback(move |next_link: Option<Url>| {
            ...
            async move {
                let rsp: Response<WorkloadNetworkPortMirroringList> =
    ...
    pub async fn update(
        ...
        port_mirroring_id: String,
        workload_network_port_mirroring: RequestContent<WorkloadNetworkPortMirroring>,
        options: Option<AVSWorkloadNetworkPortMirroringProfilesClientUpdateOptions<'_>>,
    ) -> Result<Response<WorkloadNetworkPortMirroring>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
