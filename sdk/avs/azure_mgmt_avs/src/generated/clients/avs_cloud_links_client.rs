...
impl AVSCloudLinksClient {
    ...
    /// Create a CloudLink
    pub async fn create_or_update(&self, resource_group_name: String, private_cloud_name: String, cloud_link_name: String, cloud_link: RequestContent<CloudLink>, options: Option<AVSCloudLinksClientCreateOrUpdateOptions<'_>>) -> Result<Response<CloudLink>> {
    ...
    /// Delete a CloudLink
    pub async fn delete(&self, resource_group_name: String, private_cloud_name: String, cloud_link_name: String, options: Option<AVSCloudLinksClientDeleteOptions<'_>>) -> Result<Response<()>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/cloudLinks/{cloudLinkName}");
    ...
    /// Get a CloudLink
    pub async fn get(&self, resource_group_name: String, private_cloud_name: String, cloud_link_name: String, options: Option<AVSCloudLinksClientGetOptions<'_>>) -> Result<Response<CloudLink>> {
        let options = options.unwrap_or_default();
        let ctx = Context::with_context(&options.method_options.context);
        let mut url = self.endpoint.clone();
        let mut path = String::from("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/cloudLinks/{cloudLinkName}");
    ...
    pub fn list(&self, resource_group_name: String, private_cloud_name: String, options: Option<AVSCloudLinksClientListOptions<'_>>) -> Result<Pager<CloudLinkList>> {
